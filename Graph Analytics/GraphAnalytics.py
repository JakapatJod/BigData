...
# สรุปว่าโค้ดนี้ทำการวิเคราะห์กราฟด้วย GraphFrames โดยเริ่มจากการสร้างกราฟจากข้อมูลเวอร์เท็กซ์และเอดจ์ แล้วดำเนินการวิเคราะห์ต่างๆ 
# เช่น การค้นหาเอดจ์ที่เกี่ยวข้องกับ 'Alice', คำนวณ PageRank, และหาส่วนประกอบที่เชื่อมโยงกันในกราฟ
print('END')
